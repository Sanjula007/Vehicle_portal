...
<html>
	...
	<body>
		...
		<div class="page">
			...
			<div class="panel">
				<a href="" id="logo"><img src="images/user.png" width="100px" height="100px" float=left alt=""/></a>
				<h3><a href="<?php echo base_url() ?>index.php/login/profileview">MY PROFILE</a></h3>
