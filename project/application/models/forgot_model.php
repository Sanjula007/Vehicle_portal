...
class Forgot_model extends CI_Model{
		...
		public function doforget()
	{
        ...
        if ($q->num_rows > 0) {
			...
			redirect('/index.php/forgot_ctrl/forget?info=' . $info, 'refresh');
        }
		$error= "The email id you entered not found on our database ";
		redirect('/index.php/forgot_ctrl/forget?error=' . $error, 'refresh');
		...
		private function resetpassword($user)
	{
		...
		$this->db->update('user_login',array('password'=>MD5($password)));
